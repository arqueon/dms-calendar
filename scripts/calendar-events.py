...
def add_event(summary, calendar_name, start_ts, end_ts, location="", description="", all_day=False, calendar_uid="", uid="", color=""):
    all_events.append({
    ...
    try:
        ...
        for raw_obj in raw_events:
            ...
            if not comp:
                ...
                if start_ts:
                    ...
                    add_event(summary, calendar_name, start_ts, end_ts, location, description,
                              calendar_uid=source.get_uid(), uid=event_uid, color=calendar_color)
                continue
            ...
            if not rrule_prop and not rdates:
                add_event(summary, calendar_name, start_ts, end_ts, location, description,
                          calendar_uid=source.get_uid(), uid=comp.get_uid() or "", color=calendar_color)
                continue
